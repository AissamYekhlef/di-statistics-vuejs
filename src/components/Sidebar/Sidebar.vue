        ...
        items: [
          { title: 'Dashboard', icon: 'mdi-home', link: '/dashboard' },
          {
            ...
            children: [
              ...
              { title: 'Charts', icon: 'mdi-trending-up', link: '/statistics/charts'},
              { title: 'Fields', icon: 'mdi-circle-small', link: '/charts/fields'},
              { title: 'Entity Types', icon: 'mdi-circle-small', link: '/charts/entity_types'},
            ],
          },
